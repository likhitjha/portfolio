...
with body:
    ...
    def experience_unit(title, position, date, location, content, button_name, button_link, skills):
        # Title and Date
    ...
    for exp in Experience:
        experience_unit(exp[0], exp[1], exp[2], exp[3], exp[4], exp[5], exp[6], exp[7])
